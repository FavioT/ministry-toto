export const translations = {
  es: {
    ...
    contact: {
      windowTitle: "contacto.msg",
      heading: "Contacto",
      intro: "¿Tienes un proyecto en mente o simplemente quieres saludar? Escríbeme.",
  ...
  en: {
    ...
    contact: {
      windowTitle: "contact.msg",
      heading: "Contact",
      intro: "Got a project in mind or just want to say hi? Drop me a message.",
